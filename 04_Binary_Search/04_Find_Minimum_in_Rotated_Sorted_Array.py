...
# THIS IS FROM THE LEETCODE SOLUTION - COPIED FROM HERE: https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/solutions/158940/beat-100-very-simple-python-very-detailed-explanation/
class Solution:
